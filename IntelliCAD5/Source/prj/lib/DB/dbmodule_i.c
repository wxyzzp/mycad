...
const IID LIBID_DBMODULELib = {0xEE82A591,0xCDCD,0x11D2,{0xB1,0x7B,0x00,0x10,0x4B,0x22,0xE9,0x14}};


const CLSID CLSID_DBDLLLoadInfo = {0xEE82A59E,0xCDCD,0x11D2,{0xB1,0x7B,0x00,0x10,0x4B,0x22,0xE9,0x14}};
