// File: <DevDir>\sources\prj\lib\auto\AutoDimAligned.h
//
...
class ATL_NO_VTABLE CAutoDimAligned :
	public CAutoDimension,
	public CComCoClass<CAutoDimAligned, &CLSID_DimAligned>,
	public IDispatchImpl<IIcadDimAligned, &IID_IIcadDimAligned, &LIBID_IntelliCAD>
{
public:
	...
	BEGIN_COM_MAP(CAutoDimAligned)
		COM_INTERFACE_ENTRY(IIcadDimAligned)
		COM_INTERFACE_ENTRY2(IDispatch, IIcadDimAligned)
	...
	STDMETHOD(get_ExtLine1Point)(IIcadPoint** Point);
	STDMETHOD(put_ExtLine1Point)(IIcadPoint* Point);

	STDMETHOD(get_ExtLine2Point)(IIcadPoint** Point);
	STDMETHOD(put_ExtLine2Point)(IIcadPoint* Point);
};
