...
#include "OdaCommon.h"
#include "DWGdirectWriterCrypt.h"
#include "RxObjectImpl.h"

ODRX_CONS_DEFINE_MEMBERS(DWGdirectWriterCrypt, OdCrypt, RXIMPL_CONSTR);

DWGdirectWriterCrypt::DWGdirectWriterCrypt()
  : m_hCryptProv(0)
  , m_hHash(0)
  , m_hKey(0)
{}
...
void DWGdirectWriterCrypt::clear()
{
  if(m_hHash)
...
bool DWGdirectWriterCrypt::initialize(const OdSecurityParams& secParams)
{
  clear();
...
// Decrypt data. 
bool DWGdirectWriterCrypt::decryptData(OdUInt8* buffer, OdUInt32 nBufferSize)
{
...
// Encrypt data. 
bool DWGdirectWriterCrypt::encryptData(OdUInt8* buffer, OdUInt32 nBufferSize)
{
  DWORD dwBufferSize = nBufferSize; // Needed for win64
