...
const CInterfaceProxyVtbl * _grmodule_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IVisioDLLLoadInfoProxyVtbl,
    0
};

const CInterfaceStubVtbl * _grmodule_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IVisioDLLLoadInfoStubVtbl,
    0
};

PCInterfaceName const _grmodule_InterfaceNamesList[] = 
{
    "IVisioDLLLoadInfo",
    0
};

const IID *  _grmodule_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _grmodule_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _grmodule, pIID, n)

int __stdcall _grmodule_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_grmodule_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo grmodule_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _grmodule_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _grmodule_StubVtblList,
    (const PCInterfaceName * ) & _grmodule_InterfaceNamesList,
    (const IID ** ) & _grmodule_BaseIIDList,
    & _grmodule_IID_Lookup, 
    1,
    1,
