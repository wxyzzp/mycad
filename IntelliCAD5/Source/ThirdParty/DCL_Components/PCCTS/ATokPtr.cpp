...
void ANTLRTokenPtr::operator = (const ANTLRTokenPtr& rhs)
{
   // cast away const -- refcount is a mutable member
  	// protect against "xp = xp"; ie same underlying object
   ((ANTLRTokenPtr&)rhs).ref();
   deref();
   ptr_ = rhs.ptr_;
}
