...
#define ANTLRCommonTokenTEXTSIZE        	1000
#endif
...
public:
    ...
    // Added by JEL to allow const access to object
    const ANTLRChar *getText() const 
    { return ((ANTLRAbstractToken*)this)->getText(); }

    // Added by JEL to allow const access to object
    ANTLRTokenType getType() const 
    { return ((ANTLRAbstractToken*)this)->getType(); }

    // Added by JEL to allow const access to object
	 virtual int getLine() const
    { return ((ANTLRAbstractToken*)this)->getLine(); }
