...
/** Description:
    Represents a 3D polyline within an OdDbDatabase.
...
public:
  ...
  */
  ...
  /** Description:
      Returns the type of this polyline.  
      
      Remarks:
      Type can be one of:

        k3dSimplePoly - Normal polyline.
        k3dQuadSplinePoly - Spline fit polyline (quadratic).
        k3dCubicSplinePoly - Spline fit polyline (cubic).
  */
  OdDb::Poly3dType polyType() const;

  /** Description:
      Sets the type of this polyline.  
  ...
  */
  ...
  /** Description:
      Removes all spline and curve fit vertices from this polyline, so that all
      remaining vertices are normal vertices.
  */
  void straighten();

  /** Description:
      Appends the given vertex to the end of this polyline.  This polyline must be
      ...
      Return Value:
      Object ID of the newly appended vertex.
  */
  OdDbObjectId appendVertex(OdDb3dPolylineVertex*);
  ...
  /** Description:
      ...
      Arguments:
      pIndexVert (I) Vertex after which to insert the new vertex.
      ...
      Remarks:
      To insert at the beginning of the polyline, 0 can be passed for pIndexVert.
  */
  OdDbObjectId insertVertexAt(const OdDb3dPolylineVertex* pIndexVert, OdDb3dPolylineVertex* pNewVertex);
  ...
  */
  OdDbObjectId insertVertexAt(const OdDbObjectId& indexVertId, OdDb3dPolylineVertex* pNewVertex);
  ...
  */
  ...
  /** Description:
      Returns true if this polyline is closed, false otherwise (DXF 70, bit 0x01).
  */
  ...
  */
  ...
  /** Description:
      ...
      pt (O) Receives the point at the specified parameter value.

      Return Value:
      eOk if successful, otherwise an appropriate error code.
  */
  virtual OdResult getPointAtParam(double param, OdGePoint3d& pt) const;
