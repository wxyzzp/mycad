...
/** Description:
    Represents a trace entity within an OdDbDatabase.
...
public:
  ...
  */
  ...
  /** Description:
      Returns a point from this entity, specified by index (DXF 10, 11, 12, 13).

      Arguments:
      idx (I) Index of point to return.
      PntRes (O) Receives the specified point.
  */
  void getPointAt(int idx, OdGePoint3d& PntRes) const;

  /** Description:
      Sets a point for this entity, specified by index (DXF 10, 11, 12, 13).

      Arguments:
      idx (I) Index of point to set.
      Pnt (I) The point.
  */
  void setPointAt(int idx, const OdGePoint3d& Pnt);

  /** Description:
      Returns the thickness, or depth along the normal, for this entity (DXF 39).
  */
  double thickness() const;

  /** Description:
      Sets the thickness, or depth along the normal, for this entity (DXF 39).
  */
