...
public:
  ...
  virtual void rxAppLoaded(const OdString& moduleName);
  virtual void rxAppLoadAborted(const OdString& moduleName);

  virtual void rxAppWillBeUnloaded(const OdString& moduleName);
  virtual void rxAppUnloaded(const OdString& moduleName);
  virtual void rxAppUnloadAborted(const OdString& moduleName);
};
