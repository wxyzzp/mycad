...
namespace Oda
{
  ...
  {
    kFileRead    = 0x80000000,// Specifies read access to the object.
...
{
public:
  OdError_InvalidIndex() : OdError(eInvalidIndex){}
};
...
{
public:
  OdError_InvalidKey() : OdError(eInvalidKey){}
};
...
/** Description:
    ...
    {group:OdDb_Classes}
*/
class FIRSTDLL_EXPORT OdDbSystemServices : public OdRxObject
{
public:
  ///////////////// FILE SYSTEM SERVICES //////////////////
  ...
  */
  ...
  /** Description:
  */
  virtual OdRxModulePtr loadModule(const OdString& moduleFileName, bool bSilent = true);
  virtual void unloadModule(OdRxModulePtr& pModule, bool bSilent = true);

  /** Description:
  */
  virtual bool loadApp(const OdString& appName);
...
FIRSTDLL_EXPORT OdDbSystemServices* odSystemServices();
