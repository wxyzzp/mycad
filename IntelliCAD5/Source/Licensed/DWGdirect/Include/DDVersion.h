...
#define DD_MINOR_VERSION   12
#define DD_TYPELIB_VER(MAJ,MIN) version(##MAJ##.##MIN##)
#define DD_MAJOR_BUILD_VERSION 1
#define DD_MINOR_BUILD_VERSION 0

#define PRODUCT_VER_STR "1, 12, 1, 0\0"
#define BUILD_COMMENTS  "DWGdirect 1.12.01.00\0"

#define DD_BINARY_COMPATIBILITY DD_BIN_COMP_VAL(2)
