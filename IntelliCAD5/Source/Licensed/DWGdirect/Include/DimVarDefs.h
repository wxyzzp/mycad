...
BLKVAR_DEF(OdDbHardPointerId, blk,    342,    (NULL),               (NULL),               (5),       ValidateNone())
BLKVAR_DEF(OdDbHardPointerId, blk1,   343,    (NULL),               (NULL),               (6),       ValidateNone())
BLKVAR_DEF(OdDbHardPointerId, blk2,   344,    (NULL),               (NULL),               (7),       ValidateNone())
