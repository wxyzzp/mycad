...
/** Description:
    Represents an angular dimension defined by 2 lines within an OdDbDatabase.
...
public:
  ...
  */
  ...
  /** Description:
      Returns the point defining the dimension arc, in WCS (DXF 16 as WCS).
  */
  OdGePoint3d arcPoint() const;

  /** Description:
      Sets the point defining the dimension arc, in WCS (DXF 16 as WCS).
  */
  ...
  */
  ...
  /** Description:
      ...
      (DXF 13).
  */
  void setXLine1Start(const OdGePoint3d&);
  
  /** Description:
      Returns the end point of the first extension line of this dimension, in WCS 
      (DXF 14).
  */
  OdGePoint3d xLine1End() const;

  /** Description:
      Sets the end point of the first extension line of this dimension, in WCS 
      (DXF 14).
  */
  void setXLine1End(const OdGePoint3d&);
  ...
  */
  ...
  /** Description:
      ...
      (DXF 15).
  */
  void setXLine2Start(const OdGePoint3d&);
  
  /** Description:
      Returns the end point of the second extension line of this dimension, in WCS 
      (DXF 10).
  */
  OdGePoint3d xLine2End() const;

  /** Description:
      Sets the end point of the second extension line of this dimension, in WCS 
      (DXF 10).
  */
  void setXLine2End(const OdGePoint3d&);
