...
public:
  /** Description:
      Performs loading of specified xref.
  */
  static void reload(OdDbDatabase* pHostDb, const OdChar* szXrefBlockname, bool bQuiet = true, bool bForceReload = true);

  /** Description:
      Performs loading of specified xrefs.
  */
  static void reload(OdDbObjectIdArray& xrefBTRids, bool bQuiet = true, bool bForceReload = true);

  /** Description:
      Performs loading of specified xref.
  */
  static void reload(OdDbBlockTableRecord* pBTR, bool bQuiet = true, bool bForceReload = true);

  /** Description:
      Performs loading of all xrefs.
  */
  static void reloadAll(OdDbDatabase* pHostDb, bool bQuiet = true, bool bForceReload = true);

  /** Description:
      Performs unloading of specified xref.
  */
  static void unload(OdDbBlockTableRecord* pBTR, bool bQuiet = true, bool bSetUnloaded = true);

  /** Description:
      Performs unloading of specified xrefs.
  */
  static void unload(OdDbObjectIdArray& xrefBTRids, bool bQuiet = true, bool bSetUnloaded = true);

  /** Description:
      Performs binding of specified xref.
  */
  static void bind(OdDbBlockTableRecord* pBTR, bool bPrefixName, bool bQuiet = true);

  /** Description:
      Performs detaching of specified xref.
  */
  static void detach(OdDbBlockTableRecord* pBTR, bool bQuiet = true);
