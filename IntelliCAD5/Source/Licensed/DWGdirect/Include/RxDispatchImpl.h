...
protected:
  ...
  public:
    ...
    {
      return OdRxDictionaryIteratorPtr(new Iterator(pOwner, pDescIter), kOdRxObjAttach);
    }
...
// pmk 09.01.2004 -- unreachable code
  ...
  bool resetKey(OdUInt32 , const OdString& ) { 
          throw OdError(eNotApplicable); 
// pmk 09.01.2004 -- unreachable code
// GU: condition is commented out since it is incorrect
// it produces warning under VC6
// #if !defined(WIN32) && !defined(WIN64)
          return false; 
// #endif
  }
...
#define ODRX_DEFINE_PROPERTY_METHODS(PropName, PropHolder, getMethodName, putMethodName) \
...
#define ODRX_DEFINE_PROPERTY(PropName, PropHolder) ODRX_DEFINE_PROPERTY_METHODS(PropName, PropHolder, get_##PropName, put_##PropName)
