...
/** Description:
    Represents a point (position in) 3D space.
...
public:
	...
	*/
	OdGePosition3d  ();
	OdGePosition3d (const OdGePoint3d& pnt);
	OdGePosition3d (double x, 
		double y, 
		double z);
	OdGePosition3d (const OdGePosition3d& pos);
	...
	/** Description:
		...
		z (I) The z-coordinate of the point.
	*/
	OdGePosition3d& set (const OdGePoint3d& pnt);
	OdGePosition3d& set (double x, 
		double y, 
		double z);
	
	// Assignment operator.
	OdGePosition3d& operator =  (const OdGePosition3d& pos);
};
