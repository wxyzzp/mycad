...
/** Description:
	Represents a *point* along a 3D *curve*.
...
public:
	...
	*/
	OdGePointOnCurve3d ();
	OdGePointOnCurve3d (const OdGeCurve3d& crv, 
		double param = 0.0);
	...
	*/
	...
	/** Description:
		...
		crv (I) Any 3D *curve*. Sets the current *curve*.
	*/
	OdGePoint3d point () const;
	OdGePoint3d point (double param);
	OdGePoint3d point (const OdGeCurve3d& crv, 
		double param);
	...
	*/
	...
	/** Description:
		...
		crv (I) Any 3D *curve*.
	*/
	OdGePointOnCurve3d& setCurve (const OdGeCurve3d& crv);
...
inline OdGePointOnCurve3d& OdGePointOnCurve3d::setCurve (const OdGeCurve3d& crv)
{
 m_pCurve = &crv;
 return *this;
}

inline OdGePointOnCurve3d& OdGePointOnCurve3d::setParameter (double param)
{
 m_param = param;
 return *this;
}
