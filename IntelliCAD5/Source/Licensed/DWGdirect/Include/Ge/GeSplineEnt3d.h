...
public:
  ...
  /*int continuityAtKnot (int idx, const OdGeTol& tol =
	...
	/** Description:
		Returns parameter corresponding to the start point of this spline.
	*/
	double startParam () const;

	/** Description:
		Returns parameter corresponding to the end point of this spline.
	*/
	...
	*/
	virtual double knotAt (int idx) const = 0;
	...
	*/
	virtual OdGeSplineEnt3d& setKnotAt (int idx, 
		double val) = 0;
	...
	*/
	virtual OdGePoint3d controlPointAt (int idx) const = 0;
	...
	*/
	virtual OdGeSplineEnt3d& setControlPointAt (int idx, const OdGePoint3d& pnt) = 0;
