...
/** Description:
    ...
    {group:Other_Classes}
*/
class TOOLKIT_EXPORT OdHatchPatternManager : public OdRxObject
{
public:
  ...
  */
  virtual OdResult appendPattern(OdDbHatch::HatchPatternType hpType, const OdString& patternName, 
