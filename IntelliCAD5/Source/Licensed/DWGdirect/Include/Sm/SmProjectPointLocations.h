...
#include "SmProjectPointLocation.h"
#include "SmEnum.h"
...
namespace dst
{
  ...
  */
  struct SMDLL_EXPORT OdSmProjectPointLocations : OdSmComponent
  {
    ...
    const OdSmProjectPointLocation* getLocation( OdWString locationName ) const;
    void removeLocation( OdSmProjectPointLocation* location );
    OdSmProjectPointLocation* addNewLocation( OdWString name, OdWString url, 
      OdWString folder, OdWString username, OdWString password );
    OdSmEnumProjectPointLocationPtr getEnumerator() const;
  };
