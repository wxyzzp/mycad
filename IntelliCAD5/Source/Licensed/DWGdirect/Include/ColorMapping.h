...
TOOLKIT_EXPORT const ODCOLORREF * odcmAcadDarkPalette();

// Returns palette for light background
TOOLKIT_EXPORT const ODCOLORREF * odcmAcadLightPalette();

// Returns palette for given background
TOOLKIT_EXPORT const ODCOLORREF * odcmAcadPalette(ODCOLORREF backgr);


// Returns RGB for given ACI (AutoCAD color index)
// pPalette - palette to perform mapping
TOOLKIT_EXPORT ODCOLORREF odcmLookupRGB(int idx, const ODCOLORREF* pPalette);

// Returns ACI (AutoCAD color index) for given RGB
// pPalette - palette to perform mapping
TOOLKIT_EXPORT int odcmLookupACI(ODCOLORREF rgb, const ODCOLORREF* pPalette);
