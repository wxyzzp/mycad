...
public:
  ...
  */
  ...
  /** Description:
      Returns the Block Table ID of this database.

      Return Value:
      This database's Block Table Object ID.
  */
  OdDbObjectId getBlockTableId() const;

  /** Description:
      Returns the Layer Table ID of this database.

      Return Value:
      This database's Layer Table Object ID.
  */
  OdDbObjectId getLayerTableId() const;

  /** Description:
      Returns the TextStyle Table ID of this database.

      Return Value:
      This database's TextStyle Table Object ID.
  */
  OdDbObjectId getTextStyleTableId() const;

  /** Description:
      Returns the Linetype Table ID of this database.

      Return Value:
      This database's Linetype Table Object ID.
  */
  OdDbObjectId getLinetypeTableId() const;

  /** Description:
      Returns the View Table ID of this database.

      Return Value:
      This database's View Table Object ID.
  */
  OdDbObjectId getViewTableId() const;

  /** Description:
      Returns the UCS Table ID of this database.

      Return Value:
      This database's UCS Table Object ID.
  */
  OdDbObjectId getUCSTableId() const;

  /** Description:
      Returns the Viewport Table ID of this database.

      Return Value:
      This database's Viewport Table Object ID.
  */
  OdDbObjectId getViewportTableId() const;

  /** Description:
      Returns the RegApp Table ID of this database.

      Return Value:
      This database's RegApp Table Object ID.
  */
  OdDbObjectId getRegAppTableId() const;

  /** Description:
      Returns the DimStyle Table ID of this database.

      Return Value:
      This database's DimStyle Table Object ID.
  */
...
#undef VAR_DEF
  ...
  */
  void purge(OdDbObjectIdArray& ids);
  ...
  */
  void countHardReferences(const OdDbObjectIdArray& ids, OdUInt32* pCount);
  ...
  */
  virtual OdString findActiveLayout(bool allowModel);
  ...
  */
  virtual OdDbObjectId findLayoutNamed(const OdString& name);
...
TOOLKIT_EXPORT void odDbSetTDCREATE(OdDbDatabase& db, OdDbDate date);
TOOLKIT_EXPORT void odDbSetTDUCREATE(OdDbDatabase& db, OdDbDate date);
TOOLKIT_EXPORT void odDbSetTDUPDATE(OdDbDatabase& db, OdDbDate date);
